...
export const foodCategory = (latitude, longitude) => request({
...
export const foodDelivery = (latitude, longitude) => request({
...
export const foodActivity = (latitude, longitude) => request({
